---
title: Login and Basic Controls
sidebar_position: 2
---
...
1. Confirm that the URL, protocol, and domain match the information provided by your organization. Do not enter through links in unfamiliar emails or chats.
2. Enter the administrator account and password assigned to you.
...
| --- | --- |
| **Language** | Use the language control at the bottom of the sidebar to switch among English, Traditional Chinese, and Simplified Chinese. After switching, confirm that the current page title and fields have updated |
| **Theme** | Use the theme button at the top of the sidebar to switch between dark and light modes. This changes only the display |
...
3. Click “Log Out”; do not merely close the browser tab.
4. On a shared device, also close the browser window so the session cannot be restored.
