...
# Virtu Capital 管理員使用指南

本手冊僅供獲得授權的系統管理員、超級管理員、營運和風控人員使用。每篇指南聚焦一類後台任務；已確認的 V102 頁面配有截圖，尚待補圖的位置保留了明確文字說明，不影響按步驟操作。

| 入門與儀表盤 | 客戶管理 |
| --- | --- |
| [成為管理員](./getting-started/admin-role)<br/><small>角色開通與權限邊界</small> | [投資者管理](./users/investors)<br/><small>搜尋、詳情、角色與帳戶操作</small> |
| [登入與基礎設定](./getting-started/login)<br/><small>登入、語言、主題與安全登出</small> | [個人與企業客戶](./users/customers)<br/><small>KYC、KYB、開戶資料與企業開戶</small> |
| [儀表盤概覽](./getting-started/dashboard)<br/><small>平台資產、資金與系統狀態</small> | [角色權限對照](./reference/permissions)<br/><small>管理員與超級管理員權限範圍</small> |
